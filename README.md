...
* [piVCCU](https://github.com/alexreinert/piVCCU) - piVCCU is a project to install the original Homematic CCU2 firmware inside a virtualized container (lxc) on a Raspberry Pi running Raspbian Jessie or Stretch.
